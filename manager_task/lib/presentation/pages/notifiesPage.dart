    ...
    //final int groupID=(ModalRoute.of(context)?.settings.arguments??0) as int;
          ...
          return Scaffold(
            appBar: AppBar(
                ...
                title:
                    !_searchBoolean ? Text("Notifies") : _searchTextField(context),
            ...
            body: Column(
              children: [
                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      Text(DateFormat("yyyy-MM-dd").format(selectedDateTime)+" "+selectedTime.format(context)),
                      IconButton(
                          ...
                          child: SingleChildScrollView(
                            ...
                            child: Container(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Text(
                                      "${" ${NotifyRepo.allNotifies[index].title!}\n ${NotifyRepo.allNotifies[index].body!}\n"} ${NotifyRepo.allNotifies[index].date_time.toString()}"),
                                  
                                    IconButton(
                                        onPressed: () async{
                                         await NotificationService().deleteNotify(NotifyRepo.allNotifies[index].id).then((value) => setState(() {
