  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      ...
      providers:[
        BlocProvider(
          create: 
            (context) => AuthBloc(AuthBlocState(message: "авторизация", isSucces: false, countTries: 0)))
      ],
                            ...
                            Container(
                              ...
                              margin: EdgeInsets.fromLTRB(50, 0, 50, 100),
                                ...
                                child: ElevatedButton(
                                  ...
                                  child: Text("Войти"),
                                  onPressed: () async {
                                    BlocProvider.of<AuthBloc>(context).add(tryGetAccesEvent(password: passController.text, email: emailController.text, count: state.countTries!));
